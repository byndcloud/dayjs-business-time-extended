...
describe('Subtract Business Time', () => {
  ...
  it('should subtract 90 business seconds on a date crossing working segments', () => {
    const date = dayjs('2021-02-03 13:00:30');
    const expected = dayjs('2021-02-03 11:59:00');

    const newDate = date.subtractBusinessTime(90, 'seconds');
  ...
  it('should preserve minute and second when subtracting 24 business hours from a date with seconds using subtractBusinessTime', () => {
    ...
    const newDate = date.subtractBusinessTime(24, 'hours');
